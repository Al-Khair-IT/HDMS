...
**What to do:**
- Create Django project structure with apps folder
- Create Next.js project with App Router
- Set up folder structure as per architecture docs
- Configure basic settings files (base, dev, prod)
- Set up `.env` files and `.gitignore`
...
- `backend/apps/` (users, tickets, chat, notifications, departments, audit)
- `frontend/app/`, `frontend/components/`, `frontend/services/`, etc.
...
**Connections:**
- Connects to: Django settings
- Required for: All models, migrations

**Configuration:**
- Update `DATABASES` in Django settings
- Create `.env` with database credentials

---

### **Task 1.3: BaseModel & Core Utilities**
**Priority:** 🔴 CRITICAL  
**Estimated Time:** 2-3 hours

**What to do:**
- Create `BaseModel` abstract class with UUID, soft delete, timestamps
- Create `SoftDeleteManager` and `SoftDeleteQuerySet`
- Create common utilities (helpers, validators)
...
- Required for: All database models

**Files to create:**
- `backend/core/models.py` (BaseModel)
- `backend/core/managers.py` (SoftDeleteManager)
